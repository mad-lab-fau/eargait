...
with (HERE.parent / "README.md").open() as f:
    out = f.read()
out = out.replace("./docs/_static/logo/WalkingHearingAid.pdf", "./_static/logo/WalkingHearingAid.pdf")
...
linkcode_resolve = make_linkcode_resolve(
    "eargait",
    "https://github.com/mad-lab-fau/eargait/blob/{revision}/{package}/{path}#L{lineno}",
)
